...
import { staticChapters } from "@renderer/components/common/ChapterList";
...
export default function Project() {
    ...
    useEffect(() => {
        // Randomly decide whether to show populated or empty data for each component
        setChapters(Math.random() > 0.5 ? staticChapters : [])
        
        setStreamData(Math.random() > 0.5 ? [
        ...
        setContributors(Math.random() > 0.5 ? [
            { id: 1, name: "Shubham" },
            { id: 2, name: "Alice" },
            { id: 3, name: "Bob" },
            { id: 4, name: "Charlie" },
